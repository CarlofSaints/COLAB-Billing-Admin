...
const samples: { label: string; mail: { subject: string; html: string } }[] = [
  ...
  {
    label: "Vehicle booked — to the booker",
    mail: vehicleBookedEmail({
      name: "Sky Roos",
      vehicleName: "Toyota Corolla 1.6",
      vehicleReg: "CA 123-456",
      vehicleNickname: "Little Baby",
      driverName: "Sky Roos",
      bookedByName: "Sky Roos",
      takenOnLabel: "Wed, 5 Aug 2026, 09:30",
      expectedReturnLabel: "Wed, 5 Aug 2026, 16:00",
      bookingsUrl: `${BASE}/vehicle-bookings`,
      audience: "booker" as const,
      purpose: null,
      forService: false,
    }),
  },
  {
    // The copy that goes to somebody who didn't ask for any of this — it has to
    // lead with who booked it and why they're being told.
    label: "Vehicle booked — to the driver it was booked for",
    mail: vehicleBookedEmail({
      name: "Meya Ndlovu",
      vehicleName: "Toyota Corolla 1.6",
      vehicleReg: "CA 123-456",
  ...
  {
    // The Notifications-page copy: neither booked it nor is driving it, so
    // "You've booked…" and "X booked it for you" are both wrong.
    label: "Vehicle booked — to an organiser copied in",
    mail: vehicleBookedEmail({
      name: "Tyrone Manicha",
      vehicleName: "Toyota Corolla 1.6",
      vehicleReg: "CA 123-456",
      ...
      expectedReturnLabel: "Wed, 5 Aug 2026, 16:00",
      bookingsUrl: `${BASE}/vehicle-bookings`,
      audience: "observer" as const,
      forService: false,
      purpose: "Client meeting in Claremont, then dropping stock at the Epping branch.",
    }),
  },
  {
    label: "Vehicle overdue — to an organiser copied in",
    mail: vehicleOverdueEmail({
      name: "Tyrone Manicha",
      vehicleName: "Toyota Corolla 1.6",
      vehicleReg: "CA 123-456",
      vehicleNickname: "Little Baby",
  ...
  },
  {
    ...
    mail: vehicleReturnedEmail({
      ...
      takenOnLabel: "Wed, 5 Aug 2026, 09:30",
      expectedReturnLabel: "Wed, 5 Aug 2026, 16:00",
      returnedLabel: "Wed, 5 Aug 2026, 15:42",
      bookingsUrl: `${BASE}/vehicle-bookings`,
      openingMileageLabel: "84 175 km",
      closingMileageLabel: "84 312 km",
      distanceLabel: "137 km",
      openingFuelLabel: "Full",
      closingFuelLabel: "Quarter",
      notes: "Small scratch on the rear passenger door — it was there when I took it.",
      refuel: { paidByLabel: "my own money", amountLabel: "R 742.50", hasReceipt: true },
      signedInByName: "Meya Ndlovu",
    }),
  },
  {
    // A vehicle whose odometer readings are switched off on the register, with
    // no refuelling: the shortest this email ever gets.
    label: "Vehicle returned — mileage not tracked, no fuel bought",
    mail: vehicleReturnedEmail({
      name: "Sky Roos",
      ...
      returnedLabel: "Wed, 5 Aug 2026, 15:42",
      bookingsUrl: `${BASE}/vehicle-bookings`,
      openingMileageLabel: null,
      closingMileageLabel: null,
      distanceLabel: null,
      openingFuelLabel: "Half",
  ...
  {
    label: "Vehicle booking cancelled — to the other person",
    mail: vehicleBookingCancelledEmail({
      name: "Meya Ndlovu",
      vehicleName: "Toyota Corolla 1.6",
      vehicleReg: "CA 123-456",
      vehicleNickname: "Little Baby",
  ...
  {
    // The receipt copy: they pressed the button, so it confirms rather than
    // informs, and drops the "book it again" nudge.
    label: "Vehicle booking cancelled — to whoever cancelled it",
    mail: vehicleBookingCancelledEmail({
      name: "Sky Roos",
      vehicleName: "Toyota Corolla 1.6",
      vehicleReg: "CA 123-456",
