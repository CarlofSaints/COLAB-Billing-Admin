...
export async function GET() {
  ...
  const rows = [
    ["Sub Company", "Name", "Surname", "Email", "Cell Number"],
    ["OuterJoin", "Jane", "Doe", "jane@outerjoin.co.za", "082 123 4567"],
    ["COLAB", "John", "Smith", "john@colab2.co.za", "083 987 6543"],
  ];

  const ws = XLSX.utils.aoa_to_sheet(rows);
  ws["!cols"] = [{ wch: 20 }, { wch: 16 }, { wch: 16 }, { wch: 28 }, { wch: 16 }];
